...
public class SFFTScalogram extends AbstractDemoApplication {
    ...
    private void recalculate(final ActionEvent evnt) {
        ...
        DataSet3D dataWavelet = wtrafo.getScalogram(rawDataSet.getValues(DataSet.DIM_X), demoProperties.getnWaveletF(),
    ...
    private DataSet loadSyntheticData() {
        int MAX_POINTS = demoProperties.getnSamples();
        double SAMPLE_RATE = demoProperties.getsampleRate();
    ...
    public class SfftDemoProperties {
        ...
        //        final static double SFFT_OVERLAP = 0.96;
        //
        //        // wavelet constants
        // nFFT
